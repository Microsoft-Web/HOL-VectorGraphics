...
### Introduction ###HTML5 provides many new APIs and features, two of which are the **Canvas** element and **SVG**, which allow us to create graphics and animations. 
...
If you find any issues with this hands-on lab that you can't fix, feel free to report them in the [issues](https://github.com/Microsoft-Web/HOL-VectorGraphics/issues) section of this repository.